...
The project entails application deployment for our AirBnB clone. In this project, I added a web server that serves dynamic content to my infrastructure, plugged it to my Nginx and made it serve my Airbnb clone project.

## Tasks :page_with_curl:

* **0. Set up development with Python**
  * I configured the file `web_flask/0-hello_route.py` from my
  [AirBnB_clone_v2](https://github.com/jannelson36/AirBnB_clone_v2) to serve content
  on the route `/airbnb-onepage/`, running on port `5000`.

* **1. Set up production with Gunicorn**
  * I set up a production environment, installing and configuring
