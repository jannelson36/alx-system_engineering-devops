...
This was the third project for the web stack debugging series. The project
entails broken/bugged webstacks in isolated containers
and I was tasked with fixing the web stack to a fully functional state. For each
of the task, I have written a script automating the commands necessary to fix the
web stack.
